...
public class SCY_graphicLibEffects {
  ...
  public static void customLight(
      Vector2f loc,
  ...
  public static void CustomBubbleDistortion(
      Vector2f loc,
      Vector2f vel,
      float size,
      float intensity,
  ...
  public static void CustomRippleDistortion(
      Vector2f loc,
      Vector2f vel,
      float size,
      float intensity,
  ...
  public static void CustomStaticRippleDistortion(
      Vector2f loc,
      Vector2f vel,
      float size,
      float intensity,
